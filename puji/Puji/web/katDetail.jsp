...
<head>
  ...
  <title>Daftar Menu Dalam Kategori <%out.print(request.getParameter("kode")); %> Admin | Ayam Bakar Wong Solo</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box-header with-border">
        <h3 class="box-title">Daftar Menu Dalam Kategori Ini</h3>
...
p.close();
                ...
                <div class="box-footer text-center">
                    <a class="btn btn-warning" href="editKat.php?kode=<%
                        ...
                        <div id="del" role="modal" class="modal fade">
