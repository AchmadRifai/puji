...
<head>
  ...
  <title>Tambah Bahan Admin | Ayam Bakar Wong Solo</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div class="box box-primary">
            ...
            <form role="form" action="addBahan.exe" method="POST">
                            <div class="form-group">
                                <label for="kode">Kode Untuk Bahan *</label>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stok" class="form-control" value="0.0" name="stok" min="0.0" step="0.01" required>
                </div>
                <div class="form-group">
                    <label for="satuan">Satuan *</label>
                    <input type="text" id="satuan" class="form-control" value="" name="satuan" required>
                </div>
