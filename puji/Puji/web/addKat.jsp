...
<head>
  ...
  <title>Tambah Kategori Menu Admin | Ayam Bakar Wong Solo</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div class="box box-primary">
            ...
            <form role="form" action="addKat.exe" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="kode">Kode *</label>
                    <input type="number" id="kode" class="form-control" value="0" name="kode" min="1" step="1" required>
                </div>
                <div class="form-group">
