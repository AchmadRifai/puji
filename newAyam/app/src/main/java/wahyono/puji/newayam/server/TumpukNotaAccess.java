...
public class TumpukNotaAccess extends AsyncTask<Void, Void, Boolean> {
    private Activity a;
    private Runnable ya, tidak;

    public TumpukNotaAccess(Activity a, Runnable ya, Runnable tidak) {
        this.a = a;
        this.ya = ya;
        this.tidak = tidak;
    }
    ...
    protected Boolean doInBackground(Void... voids) {
        ...
        String nota = Work.getNota(a); try {
            String data = Work.dataAccess(Work.getURL(a) + Access.SUBMIT_NOTA + nota);
